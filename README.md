...
| **[ZeroGate](https://zero-gate-nine.vercel.app/)** | Continuous Adaptive Authentication (CAA) security dashboard. Real-time risk engine evaluates login signals (IP, device, behavior), enforces step-up or revocation. Live Firestore telemetry. | `React 19` `Node.js` `Firebase` `Firestore` `Vercel` |
