...
| **[Veentra](https://veentra.vercel.app)** | AI contract review for solo attorneys & small business. Flags risky clauses, extracts deadlines, splits obligations in <1 minute. | `Next.js` `TypeScript` `Google Gemini` `Supabase` `Stripe` | **[ZeroGate](https://github.com/Mosspheree/ZeroGate)** | Continuous Adaptive Authentication (CAA) security dashboard. Real-time risk engine evaluates login signals (IP, device, behavior), enforces step-up or revocation. Live Firestore telemetry. | `React 19` `Node.js` `Firebase` `Firestore` `Vercel` |
...
### Aerospace / Systems
![YAMCS](https://img.shields.io/badge/YAMCS-FF6B35?style=for-the-badge&logo=rocket&logoColor=white)
![Linux](https://img.shields.io/badge/Linux-FCC624?style=for-the-badge&logo=linux&logoColor=black)
![Embedded](https://img.shields.io/badge/Embedded_Systems-00979D?style=for-the-badge&logo=arduino&logoColor=white)
...
* **Portfolio:** [mostafa-portfolio-eight.vercel.app](https://mostafa-portfolio-eight.vercel.app/)
